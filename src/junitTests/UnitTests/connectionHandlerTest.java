...
public class connectionHandlerTest {
	...
	private static void initiateTestPlatform() {
		...
		ch = new ConnectionHandler("192.168.1.105", 3333);
		//ch.initiateForum("forumNew2", "ADMIN2", "ADMINPASS2", superAdminName, superAdminPasswaord)
		Forum forum = ch.getForum(FORUM_NAME);
	...
	public void getSubForumTest() {
		//User u = new User(ch);
		Member a = ch.login(FORUM_NAME, ADMIN_NAME, ADMIN_PASSWORD);
		assertNotNull(a);
		Admin ad = (Admin) a;
