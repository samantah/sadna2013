...
public class MainFrameAsSuperAdmin extends ForumJFrame {
	...
	private void jButtonInitiateForumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInitiateForumActionPerformed
		...
		if (!this.jTextFieldNumberOfMsgs.getText().isEmpty())
			numberOfMsgs = Integer.parseInt(this.jTextFieldNumberOfMsgs.getText());
		if (!this.jTextNumberOfWeeks.getText().isEmpty())
			timeOfSeniority = Integer.parseInt(this.jTextNumberOfWeeks.getText());
		...
		StringTokenizer st = new StringTokenizer(forbiddenWords, " \n\r");
		while(st.hasMoreTokens()){
			String s = st.nextToken();
			sb.append(s);
			sb.append(" ");
		}
		forbiddenWords = sb.toString();
